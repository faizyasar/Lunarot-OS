...
<head>
  ...
  <title>LUNAROT // DEKA DESIGN SYSTEM & STYLE GUIDE v6.1 (LATEST MONOCHROME)</title>
  ...
  <style>
    ...
    /* Gothic Panel Aesthetics (Monochrome Glassmorphism) */
    .gothic-panel {
      position: relative;
    ...
    .panel-crimson {
      ...
      box-shadow: 0 0 20px rgba(251, 44, 54, 0.08);
    }
    .panel-crimson:hover {
      border-color: rgba(251, 44, 54, 0.8);
      box-shadow: 0 0 25px rgba(251, 44, 54, 0.25);
    }
    ...
    .text-glow-cyan {
      text-shadow: 0 0 10px rgba(0, 210, 239, 0.6);
    }
...
<body class="bg-[#050505] text-[#cfc9c0] font-sans antialiased min-h-screen selection:bg-white selection:text-black">

  <!-- Header Navigation -->
  <header class="sticky top-0 z-50 bg-black/85 backdrop-blur-md border-b border-white/15 px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
    <div class="flex items-center gap-3">
      <span class="text-white text-lg font-cinzel font-extrabold tracking-widest text-glow-white">✦ LUNAROT</span>
      ...
      <span class="bg-white/10 text-white font-mono text-[9px] px-2 py-0.5 border border-white/25">LATEST MONOCHROME</span>
    </div>
    <nav class="flex flex-wrap items-center gap-2 font-mono text-[10px] tracking-wider uppercase">
      <a href="#colors" class="px-3 py-1.5 border border-white/15 text-zinc-400 hover:text-white hover:border-white transition-all">01. Palette</a>
      <a href="#typography" class="px-3 py-1.5 border border-white/15 text-zinc-400 hover:text-white hover:border-white transition-all">02. Typography</a>
      <a href="#components" class="px-3 py-1.5 border border-white/15 text-zinc-400 hover:text-white hover:border-white transition-all">03. Panels & Form</a>
      <a href="#buttons" class="px-3 py-1.5 border border-white/15 text-zinc-400 hover:text-white hover:border-white transition-all">04. Buttons & Badges</a>
      <a href="#interactive" class="px-3 py-1.5 border border-white/15 text-zinc-400 hover:text-white hover:border-white transition-all">05. Workbench</a>
    </nav>
  </header>
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
    ...
    <!-- Hero Header -->
    <section class="gothic-panel panel-white space-y-4 text-center sm:text-left">
      <span class="panel-title-tag">SYSTEM_MANIFESTO // LATEST</span>
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 class="font-cinzel text-2xl sm:text-3xl font-extrabold text-white tracking-widest uppercase text-glow-white">LUNAROT OS MONOCHROME DESIGN SYSTEM</h1>
        ...
        <button onclick="copyCode(this, `/* LUNAROT MONOCHROME AESTHETIC SYSTEM */\n@import 'https://fonts.googleapis.com/css2?family=Cinzel:wght@700&family=Cormorant+Garamond:ital,wght@0,400;1,400&family=JetBrains+Mono:wght@400;700&display=swap';`)" class="gothic-btn-white shrink-0">
          [ COPY ALL TOKENS ]
        </button>
      </div>
      <span class="panel-footer-tag">MONOCHROME_FOUNDATION</span>
    </section>
    ...
    <section id="colors" class="space-y-6">
      <div class="border-b border-white/15 pb-3 flex justify-between items-end">
        <div>
          <h2 class="font-cinzel text-xl font-bold text-white tracking-widest uppercase flex items-center gap-2">
            <span class="text-white">✦</span> 01. COLOR PALETTE TOKENS (MONOCHROME & ACCENTS)
          </h2>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 font-mono">
        ...
        <!-- Pure White -->
        <div onclick="copyHex(this, '#ffffff')" class="gothic-panel panel-white group cursor-pointer hover:-translate-y-1 transition-all">
          <span class="panel-title-tag">PURE_WHITE</span>
          <div class="h-24 w-full bg-[#ffffff] rounded-none border border-white/30 shadow-[0_0_15px_rgba(255,255,255,0.4)] group-hover:scale-[1.02] transition-transform"></div>
          <div class="mt-4 space-y-1">
            <div class="text-xs font-bold text-black flex justify-between">
              <span>PURE WHITE</span>
              <span class="text-zinc-300">#ffffff</span>
            </div>
            <p class="text-[10px] text-zinc-400 font-sans">Primary headings, active highlights, top border lines.</p>
          </div>
          <span class="panel-footer-tag">HEADER_WHITE</span>
        </div>

        <!-- Glass Silver Translucent -->
        <div onclick="copyHex(this, 'rgba(255,255,255,0.2)')" class="gothic-panel panel-white group cursor-pointer hover:-translate-y-1 transition-all">
          <span class="panel-title-tag">GLASS_SILVER</span>
          <div class="h-24 w-full bg-white/20 backdrop-blur-md rounded-none border border-white/40 group-hover:scale-[1.02] transition-transform"></div>
          <div class="mt-4 space-y-1">
            <div class="text-xs font-bold text-white flex justify-between">
              <span>GLASS SILVER</span>
              <span class="text-zinc-400">WHITE/20</span>
            </div>
            <p class="text-[10px] text-zinc-400 font-sans">Glassmorphic panel borders, card stack separators.</p>
          </div>
          <span class="panel-footer-tag">BORDER_TRANSLUCENT</span>
        </div>
        ...
        <!-- Crimson Ritual -->
        <div onclick="copyHex(this, '#fb2c36')" class="gothic-panel panel-crimson group cursor-pointer hover:-translate-y-1 transition-all">
        ...
        <!-- Black 60% Glass Overlay -->
        <div onclick="copyHex(this, 'rgba(0,0,0,0.6)')" class="gothic-panel group cursor-pointer hover:-translate-y-1 transition-all">
          <span class="panel-title-tag">GLASS_BACKDROP</span>
          <div class="h-24 w-full bg-black/60 backdrop-blur-md rounded-none border border-white/20 group-hover:scale-[1.02] transition-transform"></div>
          <div class="mt-4 space-y-1">
            <div class="text-xs font-bold text-white flex justify-between">
              <span>BLACK GLASS 60%</span>
              <span class="text-zinc-400">BLACK/60</span>
            </div>
            <p class="text-[10px] text-zinc-400 font-sans">Window container glassmorphism background.</p>
          </div>
          <span class="panel-footer-tag">GLASS_CONTAINER</span>
        </div>
    ...
    <section id="typography" class="space-y-6">
      <div class="border-b border-white/15 pb-3 flex justify-between items-end">
        <div>
          <h2 class="font-cinzel text-xl font-bold text-white tracking-widest uppercase flex items-center gap-2">
            <span class="text-white">✦</span> 02. TYPOGRAPHY SCALES
          </h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="gothic-panel panel-white space-y-4">
          <span class="panel-title-tag">FONT_FAMILY // CINZEL</span>
          <div class="space-y-2 border-b border-white/10 pb-4">
            <span class="font-mono text-[9px] text-white tracking-widest uppercase">.font-cinzel (Serif Display Header)</span>
            <h3 class="font-cinzel text-2xl font-bold text-white tracking-widest uppercase">LUNAROT ARCHIVAL VESSEL</h3>
            <h4 class="font-cinzel text-lg font-semibold text-white/80 tracking-wider uppercase">Chancellery of the Void // Geocentric Conflux</h4>
          </div>
          <div class="font-mono text-[10px] text-zinc-400 space-y-1">
            ...
            <p><strong class="text-white">Tailwind Class:</strong> <code class="text-white">font-cinzel tracking-widest uppercase</code></p>
          </div>
        ...
        <div class="gothic-panel panel-white space-y-4">
          ...
          <div class="space-y-2 border-b border-white/10 pb-4">
            <span class="font-mono text-[9px] text-white tracking-widest uppercase">.font-garamond (Poetic Body Text)</span>
          ...
          <div class="font-mono text-[10px] text-zinc-400 space-y-1">
            ...
            <p><strong class="text-white">Tailwind Class:</strong> <code class="text-white">font-garamond text-[#cfc9c0] leading-relaxed</code></p>
          </div>
...
TELEMETRY RESONANCE: 99.8% // STATUS: NOMINAL</pre>
          ...
          <div class="font-mono text-[10px] text-zinc-400 space-y-1">
            ...
            <p><strong class="text-white">Tailwind Class:</strong> <code class="text-white">font-mono tracking-wider</code></p>
          </div>
        ...
        <div class="gothic-panel space-y-4">
          ...
          <div class="space-y-2 border-b border-white/10 pb-4">
            ...
            <blockquote class="font-playfair text-lg text-white/90 italic border-l-2 border-white/40 pl-4 py-1">
          ...
          <div class="font-mono text-[10px] text-zinc-400 space-y-1">
            ...
            <p><strong class="text-white">Tailwind Class:</strong> <code class="text-white">font-playfair italic border-l-2 border-white/40</code></p>
          </div>
    ...
    <section id="components" class="space-y-6">
      <div class="border-b border-white/15 pb-3 flex justify-between items-end">
        <div>
          <h2 class="font-cinzel text-xl font-bold text-white tracking-widest uppercase flex items-center gap-2">
            <span class="text-white">✦</span> 03. GOTHIC PANELS & INPUT FIELDS
          </h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono">
        ...
        <!-- White Gothic Panel Specimen -->
        <div class="gothic-panel panel-white space-y-4">
          <span class="panel-title-tag">GOTHIC_PANEL // GLASS_FRAME</span>
          ...
          <p class="text-xs font-garamond text-[#cfc9c0] leading-relaxed">
            Constructed using a dark translucent background (<code class="font-mono text-xs text-white">bg-black/65</code>) with backdrop blur, a silver border (<code class="font-mono text-xs text-white">border-white/30</code>), and a dashed inset ring (<code class="font-mono text-xs text-white">border-dashed border-white/12</code>).
          </p>
          <div class="pt-2 border-t border-white/10 flex justify-between items-center text-[9px] text-zinc-400">
            <span>STATUS: NOMINAL</span>
            <button onclick="copyCode(this, `<div class=\&quot;gothic-panel panel-white\&quot;>\n  <span class=\&quot;panel-title-tag\&quot;>TITLE_TAG</span>\n  <p>Content...</p>\n  <span class=\&quot;panel-footer-tag\&quot;>FOOTER_TAG</span>\n</div>`)" class="hover:text-white underline">
              [ COPY HTML ]
            </button>
          </div>
    ...
    <section id="buttons" class="space-y-6">
      <div class="border-b border-white/15 pb-3 flex justify-between items-end">
        <div>
          <h2 class="font-cinzel text-xl font-bold text-white tracking-widest uppercase flex items-center gap-2">
            <span class="text-white">✦</span> 04. BUTTONS, BADGES & CHIPS
          </h2>
      ...
      <div class="gothic-panel panel-white space-y-6">
        <span class="panel-title-tag">BUTTON_WORKSHOP & CHIPS</span>

        <!-- Button Row -->
        <div class="space-y-3">
          <span class="font-mono text-[9px] text-white tracking-widest uppercase block">// BUTTON VARIANTS</span>
          <div class="flex flex-wrap items-center gap-4">
            <button class="gothic-btn-white">[ INITIATE CONDUIT ]</button>
        ...
        <div class="space-y-3 pt-4 border-t border-white/10">
          <span class="font-mono text-[9px] text-white tracking-widest uppercase block">// TELEMETRY BADGES & CHIPS</span>
          <div class="flex flex-wrap items-center gap-3 font-mono text-[9px]">
            <span class="border border-white/50 bg-white/10 text-white px-2.5 py-1 uppercase tracking-widest font-bold">[ OK ]</span>
    ...
    <section id="interactive" class="space-y-6">
      <div class="border-b border-white/15 pb-3 flex justify-between items-end">
        <div>
          <h2 class="font-cinzel text-xl font-bold text-white tracking-widest uppercase flex items-center gap-2">
            <span class="text-white">✦</span> 05. LIVE INTERACTIVE WORKBENCH
          </h2>
      ...
      <div class="gothic-panel panel-white space-y-6 font-mono">
        ...
        <div class="space-y-4">
          <div class="flex justify-between items-center text-xs">
            ...
            <span id="charCount" class="text-white font-bold">CHARACTERS: 124</span>
          </div>
  ...
  <footer class="border-t border-white/15 py-8 text-center font-mono text-xs text-zinc-500 space-y-2">
    <p class="tracking-widest uppercase text-zinc-400">LUNAROT OS // DEKA DESIGN SYSTEM v6.1 (LATEST MONOCHROME)</p>
