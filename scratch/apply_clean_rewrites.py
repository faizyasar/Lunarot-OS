...
# 2. Update research window top tabs bar to ONLY ["log","map","dev","social"]
...
if old_tabs_bar in content:
    ...
    print("[SUCCESS] Updated research top tabs bar")

# 3. Update switch(v) in switch case header
old_switch = 'case"/research/social-conduit.md":K("COMMUNICATIONS CONDUITS // INGRESS SOCIALS");break;'
new_switch = 'case"/research/social-conduit.md":K("COMMUNICATIONS CONDUITS // INGRESS SOCIALS");break;case"/db/music.index":K("AUDIAL TELEMETRY // SPOTIFY & LAST.FM SCROBBLES");break;case"/db/deka-archive.index":K("DEKA DRIVE GALLERY // LIVE ASSET PREVIEWER");break;'

if old_switch in content:
    content = content.replace(old_switch, new_switch)
    print("[SUCCESS] Updated switch(v) header cases")

# 4. Update Ve() function to switch on v directly
...
if old_ve_fn in content:
    ...
    print("[SUCCESS] Updated Ve() function to switch on v directly")

# 5. Update dev history up string variable to formatted 2026 umbrella
...
if up_match:
    ...
    print("[SUCCESS] Replaced up string variable")

# 6. Clean space-y-1 content area wrapper
target_str = 'children:s.jsxs("div",{className:"space-y-1",children:[rp(Ve()),E==="deka"&&'

prefix = 'children:s.jsxs("div",{className:"space-y-1",children:['
suffix = 'E==="deka"&&'

music_jsx = '''v==="/db/music.index"?s.jsxs("div",{className:"mt-2 space-y-6 font-mono",children:[
  ...
  ]):v==="/db/deka-archive.index"?'''

replacement = prefix + music_jsx + suffix

if target_str in content:
    content = content.replace(target_str, replacement)
    print("[SUCCESS] Replaced space-y-1 content area wrapper")
else:
    print("[WARN] target_str not found in index.html")

with open(index_path, "w", encoding="utf-8") as f:
    f.write(content)

print("[COMPLETE] apply_clean_rewrites complete.")
