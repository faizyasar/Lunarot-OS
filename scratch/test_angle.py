...
async def run_render():
    ...
    async with async_playwright() as p:
        ...
        () => {
            ...
            // Set up a beautiful isometric / perspective angle
            stage._camera.position.set(0, 0.12, 0.16);
            stage._controls.target.set(0, 0, 0);
            stage._controls.update();
            
            // Slightly tilt root if needed or keep standard flat orientation and orbit
        ...
        out_png = os.path.abspath(r'scratch\test_angle.png')
